// Store all values computer loses with in loserChoiceArray
// Based on this array we build our computer choices array
//   if a choice makes up 50% or more of the array add it once
//   if a choice makes up >= 25 and <= 50% add it twice
//   if a choice makes up less than 25 but > than 0 add it 3times
//   else add rest of choices 4 times
  ...
  let humanObject = {
    ...
    choose() {
      ...
      while (true) {
        ...
        console.log('Valid input: "r" for Rock, "p" for Paper, "sc" for Scissors' +
...
let compare = {
  ...
  isWinner(firstMove, secondMove) {
    return ((firstMove === 'Rock' && secondMove === 'Scissors') ||
